		...
		<div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors">
			<div className="container mx-auto px-4 py-8 max-w-4xl">
				...
				<section className="mb-8">
					<h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">計算タイプ</h2>
					<div className="bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl border border-gray-200 dark:border-gray-600 shadow-lg hover:shadow-xl transition-all duration-300">
						<h3 className="font-medium text-lg text-gray-900 dark:text-gray-100 mb-2">{calculator.displayName}</h3>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					<section className="space-y-6">
						<div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-lg">
							<div className="flex items-center justify-between mb-6">
								<h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">パラメータ入力</h2>
								<button
									type="button"
							...
							{(validationResult.errors.length > 0 || validationResult.warnings.length > 0) && (
								<div className="space-y-2">
									{validationResult.errors.map((error, index) => (
										<div key={`error-${index}`} className="flex items-center text-red-600 dark:text-red-400 text-sm bg-red-50 dark:bg-red-900/30 p-3 rounded-md border border-red-200 dark:border-red-700/50">
									...
									{validationResult.warnings.map((warning, index) => (
										<div key={`warning-${index}`} className="flex items-center text-yellow-600 dark:text-yellow-400 text-sm bg-yellow-50 dark:bg-yellow-900/30 p-3 rounded-md border border-yellow-200 dark:border-yellow-700/50">
											<svg className="w-4 h-4 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
					...
					<section className="space-y-6">
						<div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-lg">
							<h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-6">計算結果</h2>
				...
				<footer className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
					<div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-xl p-6 border border-blue-200 dark:border-blue-700/50 shadow-lg">
						<h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-3 text-lg">シュワルツシルト半径について</h3>
