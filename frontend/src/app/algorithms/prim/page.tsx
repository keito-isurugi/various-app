...
export default function PrimPage() {
	...
	const defaultInput = PrimAlgorithm.getDefaultInput();
	...
	return (
		<div className="max-w-7xl mx-auto p-4">
			...
			{/* ヘッダー */}
			<div className="mb-8">
				<h1 className="text-3xl font-bold mb-4">プリム法</h1>
				<p className="text-gray-600 dark:text-gray-400">
					重み付き無向グラフから最小全域木を構築するグリーディアルゴリズムです。
					頂点を一つずつMSTに追加していく頂点ベースのアプローチを採用します。
				</p>
			</div>
			...
			{/* 詳細説明 */}
			<div className="mt-12">
				<CalculationExplanation explanationData={primExplanation} />
			</div>
		</div>
	);
}
