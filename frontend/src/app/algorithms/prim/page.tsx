/**
 * src/app/algorithms/prim/page.tsx
 *
 * プリム法アルゴリズムの解説ページ
...
import { primExplanation } from "../../../data/explanations/prim-explanation";
import type { AlgorithmInput, AlgorithmResult } from "../../../types/algorithm";
import { PrimAlgorithm } from "../../../utils/algorithms/prim";
...
export default function PrimPage() {
	...
	const generateRandomGraph = useCallback(() => {
		const examples = PrimAlgorithm.getRecommendedExamples();
		...
		<div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors">
			<div className="container mx-auto px-4 py-8 max-w-6xl">
				...
				<nav className="mb-8 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
					...
					<span>/</span>
					<span className="text-gray-900 dark:text-gray-100">プリム法</span>
				</nav>
				...
				<section className="mb-8">
					<div className="bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-xl p-6 border border-teal-200 dark:border-teal-700">
						<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
							...
							<div className="text-center">
								<div className="text-cyan-600 dark:text-cyan-400 font-semibold text-sm">
									空間計算量
								</div>
								<div className="font-mono text-lg font-bold text-gray-900 dark:text-gray-100">
					...
					<div className="xl:col-span-1">
						<div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg sticky top-4">
							<div className="p-6">
								...
								{/* 結果表示 */}
								{result && (
									<div className="mt-6 p-4 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-lg border border-teal-200 dark:border-teal-700">
										<h3 className="font-bold text-teal-900 dark:text-teal-100 mb-3">
											✨ 実行結果
										</h3>
										{result.summary && (
											<div className="space-y-2 text-sm">
												{Object.entries(result.summary).map(([key, value]) => (
													<div key={key} className="flex justify-between">
														...
														<span className="font-mono font-medium text-teal-900 dark:text-teal-100">
															{String(value)}
														</span>
													</div>
												))}
													...
													{result.result.mst.map(
														(edge: any, edgeIndex: number) => (
															<div
																...
																className="bg-teal-50 dark:bg-teal-900/20 rounded p-3 text-sm border border-teal-200 dark:border-teal-700"
															>
				...
				<section className="mt-12">
					<CalculationExplanation
						explanationData={primExplanation}
