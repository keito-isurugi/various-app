...
export default function WarshallFloydPage() {
	...
	const defaultInput = WarshallFloydAlgorithm.getDefaultInput();
	...
	return (
		<div className="max-w-7xl mx-auto p-4">
			...
			{/* ヘッダー */}
			<div className="mb-8">
				<h1 className="text-3xl font-bold mb-4">ワーシャルフロイド法</h1>
				<p className="text-gray-600 dark:text-gray-400">
					全点間最短経路問題を解く動的計画法のアルゴリズムです。
					負の重みを含むグラフでも動作し、全ての頂点ペア間の最短距離を一度に計算します。
				</p>
			</div>
			...
			{/* 詳細説明 */}
			<div className="mt-12">
				<CalculationExplanation explanationData={warshallFloydExplanation} />
			</div>
		</div>
	);
}
