/**
 * src/app/algorithms/bubble-sort/page.tsx
 *
 * バブルソートアルゴリズムの解説ページ
...
import { bubbleSortExplanation } from "../../../data/explanations/bubble-sort-explanation";
import type { AlgorithmInput, AlgorithmResult } from "../../../types/algorithm";
import { BubbleSortAlgorithm } from "../../../utils/algorithms/bubble-sort";
...
export default function BubbleSortPage() {
	// アルゴリズムインスタンス
	const algorithm = new BubbleSortAlgorithm();
	...
	const generateRandomArray = useCallback(() => {
		...
		const array = BubbleSortAlgorithm.generateRandomArray(size, 50);
	...
	const generateReverseArray = useCallback(() => {
		...
		const array = BubbleSortAlgorithm.generateReverseArray(size);
	...
	const generateSortedArray = useCallback(() => {
		const size = Math.floor(Math.random() * 4) + 5; // 5-8個の要素
		const array = BubbleSortAlgorithm.generateSortedArray(size);
			...
			<div className="container mx-auto px-4 py-8 max-w-6xl">
						...
						{result ? (
							...
							<div className="bg-white dark:bg-gray-800 rounded-xl p-12 border border-gray-200 dark:border-gray-700 text-center mb-8">
								<div className="text-6xl mb-4">
									<ArrowDownUp className="w-16 h-16 mx-auto text-purple-500" />
								</div>
				...
				<section className="mt-12">
					<CalculationExplanation
						explanationData={bubbleSortExplanation}
