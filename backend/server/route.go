...
import (
	...
	imageTagApp "github.com/keiai0/various-app/application/image_tag"
	tagApp "github.com/keiai0/various-app/application/tag"
	"github.com/keiai0/various-app/infrastructure/env"
	db "github.com/keiai0/various-app/infrastructure/postgresql"
	"github.com/keiai0/various-app/infrastructure/postgresql/repository"
	imagePre "github.com/keiai0/various-app/presentation/http/image"
	imageTagPre "github.com/keiai0/various-app/presentation/http/image_tag"
	tagPre "github.com/keiai0/various-app/presentation/http/tag"
...
func imageRouter(ev *env.Values, awsClient s3iface.S3API, eg *echo.Group, dbClient db.Client) {
	...
	h := imagePre.NewImageHandler(
		...
		imageApp.NewListImagesNoTaggedUseCase(imageRepo),
	)
	...
	imageGroup.POST("/un_tagged", h.GetUntaggedImagesByTags)
}
